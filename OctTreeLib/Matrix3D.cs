...
/// </summary>
        ...
        public Matrix3D inverse()
        {
         ...
         MR[0, 0] = (M[1, 2] * M[2, 3] * M[3, 1] - M[1, 3] * M[2, 2] * M[3, 1] + M[1, 3] * M[2, 1] * M[3, 2] - M[1, 1] * M[2, 3] * M[3, 2] - M[1, 2] * M[2, 1] * M[3, 3] + M[1, 1] * M[2, 2] * M[3, 3]) / det;
         MR[0, 1] = (M[0, 3] * M[2, 2] * M[3, 1] - M[0, 2] * M[2, 3] * M[3, 1] - M[0, 3] * M[2, 1] * M[3, 2] + M[0, 1] * M[2, 3] * M[3, 2] + M[0, 2] * M[2, 1] * M[3, 3] - M[0, 1] * M[2, 2] * M[3, 3]) / det;
         MR[0, 2] = (M[0, 2] * M[1, 3] * M[3, 1] - M[0, 3] * M[1, 2] * M[3, 1] + M[0, 3] * M[1, 1] * M[3, 2] - M[0, 1] * M[1, 3] * M[3, 2] - M[0, 2] * M[1, 1] * M[3, 3] + M[0, 1] * M[1, 2] * M[3, 3]) / det;
         MR[0, 3] = (M[0, 3] * M[1, 2] * M[2, 1] - M[0, 2] * M[1, 3] * M[2, 1] - M[0, 3] * M[1, 1] * M[2, 2] + M[0, 1] * M[1, 3] * M[2, 2] + M[0, 2] * M[1, 1] * M[2, 3] - M[0, 1] * M[1, 2] * M[2, 3]) / det;
         MR[1, 0] = (M[1, 3] * M[2, 2] * M[3, 0] - M[1, 2] * M[2, 3] * M[3, 0] - M[1, 3] * M[2, 0] * M[3, 2] + M[1, 0] * M[2, 3] * M[3, 2] + M[1, 2] * M[2, 0] * M[3, 3] - M[1, 0] * M[2, 2] * M[3, 3]) / det;
         MR[1, 1] = (M[0, 2] * M[2, 3] * M[3, 0] - M[0, 3] * M[2, 2] * M[3, 0] + M[0, 3] * M[2, 0] * M[3, 2] - M[0, 0] * M[2, 3] * M[3, 2] - M[0, 2] * M[2, 0] * M[3, 3] + M[0, 0] * M[2, 2] * M[3, 3]) / det;
         MR[1, 2] = (M[0, 3] * M[1, 2] * M[3, 0] - M[0, 2] * M[1, 3] * M[3, 0] - M[0, 3] * M[1, 0] * M[3, 2] + M[0, 0] * M[1, 3] * M[3, 2] + M[0, 2] * M[1, 0] * M[3, 3] - M[0, 0] * M[1, 2] * M[3, 3]) / det;
         MR[1, 3] = (M[0, 2] * M[1, 3] * M[2, 0] - M[0, 3] * M[1, 2] * M[2, 0] + M[0, 3] * M[1, 0] * M[2, 2] - M[0, 0] * M[1, 3] * M[2, 2] - M[0, 2] * M[1, 0] * M[2, 3] + M[0, 0] * M[1, 2] * M[2, 3]) / det;
         MR[2, 0] = (M[1, 1] * M[2, 3] * M[3, 0] - M[1, 3] * M[2, 1] * M[3, 0] + M[1, 3] * M[2, 0] * M[3, 1] - M[1, 0] * M[2, 3] * M[3, 1] - M[1, 1] * M[2, 0] * M[3, 3] + M[1, 0] * M[2, 1] * M[3, 3]) / det;
         MR[2, 1] = (M[0, 3] * M[2, 1] * M[3, 0] - M[0, 1] * M[2, 3] * M[3, 0] - M[0, 3] * M[2, 0] * M[3, 1] + M[0, 0] * M[2, 3] * M[3, 1] + M[0, 1] * M[2, 0] * M[3, 3] - M[0, 0] * M[2, 1] * M[3, 3]) / det;
         MR[2, 2] = (M[0, 1] * M[1, 3] * M[3, 0] - M[0, 3] * M[1, 1] * M[3, 0] + M[0, 3] * M[1, 0] * M[3, 1] - M[0, 0] * M[1, 3] * M[3, 1] - M[0, 1] * M[1, 0] * M[3, 3] + M[0, 0] * M[1, 1] * M[3, 3]) / det;
         MR[2, 3] = (M[0, 3] * M[1, 1] * M[2, 0] - M[0, 1] * M[1, 3] * M[2, 0] - M[0, 3] * M[1, 0] * M[2, 1] + M[0, 0] * M[1, 3] * M[2, 1] + M[0, 1] * M[1, 0] * M[2, 3] - M[0, 0] * M[1, 1] * M[2, 3]) / det;
         MR[3, 0] = (M[1, 2] * M[2, 1] * M[3, 0] - M[1, 1] * M[2, 2] * M[3, 0] - M[1, 2] * M[2, 0] * M[3, 1] + M[1, 0] * M[2, 2] * M[3, 1] + M[1, 1] * M[2, 0] * M[3, 2] - M[1, 0] * M[2, 1] * M[3, 2]) / det;
         MR[3, 1] = (M[0, 1] * M[2, 2] * M[3, 0] - M[0, 2] * M[2, 1] * M[3, 0] + M[0, 2] * M[2, 0] * M[3, 1] - M[0, 0] * M[2, 2] * M[3, 1] - M[0, 1] * M[2, 0] * M[3, 2] + M[0, 0] * M[2, 1] * M[3, 2]) / det;
         MR[3, 2] = (M[0, 2] * M[1, 1] * M[3, 0] - M[0, 1] * M[1, 2] * M[3, 0] - M[0, 2] * M[1, 0] * M[3, 1] + M[0, 0] * M[1, 2] * M[3, 1] + M[0, 1] * M[1, 0] * M[3, 2] - M[0, 0] * M[1, 1] * M[3, 2]) / det;
         MR[3, 3] = (M[0, 1] * M[1, 2] * M[2, 0] - M[0, 2] * M[1, 1] * M[2, 0] + M[0, 2] * M[1, 0] * M[2, 1] - M[0, 0] * M[1, 2] * M[2, 1] - M[0, 1] * M[1, 0] * M[2, 2] + M[0, 0] * M[1, 1] * M[2, 2]) / det;

         Matrix3D inverseM = new Matrix3D(MR[0, 0], MR[0, 1], MR[0, 2], MR[0, 3],
