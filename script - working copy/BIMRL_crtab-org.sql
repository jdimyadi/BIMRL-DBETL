...
CREATE VIEW BIMRL_ELEMWOGEOM_&1 AS SELECT ElementID,LineNo,ElementType,ModelID,TypeID,Name,LongName,OwnerHistoryID,Description,ObjectType,Tag,Container from BIMRL_ELEMENT_&1;
